...
#from utils.general import (LOGGER, check_file, check_img_size, check_imshow, check_requirements, colorstr,
#                           increment_path, non_max_suppression, print_args, scale_coords, strip_optimizer, xyxy2xywh,strip_optimizer, set_logging)
#from utils.plots import plot_one_box;
from utils.general import (
    check_img_size, non_max_suppression, apply_classifier, scale_coords,
    xyxy2xywh,  strip_optimizer, set_logging)

#from keras.utils.vis_utils import (check_img_size, non_max_suppression, apply_classifier, scale_coords,
...
def detect(save_img=False):
    ...
    '''
    if classify:
        modelc = load_classifier(name='best', n=3)  # initialize
        modelc.load_state_dict(torch.load('best.pt', map_location=device)['model'])  # load weights
        modelc.to(device).eval()
